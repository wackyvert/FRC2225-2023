...
public class ArcadeDrive extends CommandBase {
  ...
  public void execute() {
if (!xbox) {
    RobotContainer.mDrivetrain.hDrive(ScaleInputs.scaleInputs(OperatorInput.getY()), ScaleInputs.scaleInputs(OperatorInput.getRot(), .35, .15, .7)*.55, ScaleInputs.scaleInputs(OperatorInput.getX(),.3,.15,2));
  }
  else{
